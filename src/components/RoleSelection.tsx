...
export default function RoleSelection() {
  ...
  const roles = [
    { value: 'Client' as const, icon: '👔', label: "I'm a client, hiring for a project" },
    { value: 'Freelancer' as const, icon: '💻', label: "I'm a freelancer, looking for work" },
  ]
  ...
  return (
    <Box className="flex flex-col items-center justify-center min-h-screen px-4">
      <RadioGroup value={role} onChange={e => choose(e.target.value as UserRole)}>
        <Grid
          container
          spacing={4}
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <CardContent className="flex flex-col items-center py-8">
                        ...
                        <Typography variant="h6" align="center" className="font-semibold">
                          {label}
                        </Typography>
                      </CardContent>
                    }
