...
import {
  AddressDto,
  ClientProfileDto, ForeignLanguageDto,
  FreelancerProfileDto, Role, SkillDto,
...
import { ClientProfileData, FreelancerDetailsData, FreelancerProfileData, UserDetailsData } from '../../models/Ui';
          ...
          this.store
            ...
            .subscribe((profiles) => {
              ...
              this.freelancerProfileData={
                ...
                programmingLanguages:this.freelancerProfile.skills.map((skill:SkillDto)=>skill.programmingLanguage),
                areas:this.freelancerProfile.skills.map((skill:SkillDto)=>skill.area),
                foreignLanguages:this.freelancerProfile.foreignLanguages.map(lang=>lang.language),
