...
import { DialogData, FreelancerDetailsData, UserDetailsData } from '../../models/Ui';
  ...
  onSave(): void {
    ...
    if (this.freelancerProfileForm.valid) {
      const freelancerProfileData:FreelancerDetailsData = {
        ...
        foreignLanguages:this.freelancerProfileForm.value.foreignLanguages.map((lang:Language)=>lang.name),
